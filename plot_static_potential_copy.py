...
def plot_static_potential(sm_filter=None, filename="static_potential.png", legend_cols=2):
...
plot_static_potential(sm_filter=None, filename="static_potential_all.png", legend_cols=2)
plot_static_potential(sm_filter="sm0", filename="static_potential_sm0.png", legend_cols=1)
plot_static_potential(sm_filter="sm2", filename="static_potential_sm2.png", legend_cols=1)
